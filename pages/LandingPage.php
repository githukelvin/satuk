<?php 
$title="Landing Page";
include_once "../partials/TheHeader.php"
?>
<body class=" bg-zinc-300">
    <!-- <video src="../assests/images/student Video.mp4" autoplay loop muted type="video/mp4"
    ...
    <div class="container z-10">
        ...
        <div class="mid">
            <h1>Get all the following from here:</h1>
            <ul>
                <li>Campus life</li>
            ...
            <p>Also we value your feedback also.Reach out here</p>
        </div>
    </div>
</body>
</html>